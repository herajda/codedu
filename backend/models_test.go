...
func TestListAssignmentsForStudent(t *testing.T) {
	...
	rows := sqlmock.NewRows([]string{"id", "title", "description", "created_by", "deadline", "max_points", "grading_policy", "published", "show_traceback", "show_test_details", "programming_language", "template_path", "created_at", "updated_at", "class_id"}).
		AddRow(assignmentID.String(), "A", "desc", creatorID.String(), now, 100, "all_or_nothing", true, false, false, "python", nil, now, now, classID.String())
...
func TestListAssignmentsForTeacher(t *testing.T) {
	...
	classID := uuid.New()
	rows := sqlmock.NewRows([]string{"id", "title", "description", "created_by", "deadline", "max_points", "grading_policy", "published", "show_traceback", "show_test_details", "programming_language", "template_path", "created_at", "updated_at", "class_id"}).
		AddRow(assignmentID.String(), "B", "desc", creatorID.String(), now, 100, "all_or_nothing", false, false, false, "python", nil, now, now, classID.String())
